...
export default function Auth() {
    ...
    return (
        <>
            <div className='max-w-2xl max-md:mx-10 my-10 px-3 py-5 dark:bg-neutral-900 bg-neutral-100 mx-auto border rounded-md dark:border-neutral-800 border-neutral-200 shadow-lg' >
                ...
                <form className='flex flex-col justify-center' onSubmit={(e) => loginUser(e)} >
                    ...
                    <button type='submit' className='w-full px-3 py-1 my-3 text-neutral-200 rounded-md bg-violet-600 hover:bg-violet-500 transitiona-all duration-300 '>Submit</button>
                </form>
            </div>
        </>
    )
